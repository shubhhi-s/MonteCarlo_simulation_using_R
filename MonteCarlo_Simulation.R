# PROBABILITY, RANDOM VARIABLE AND MONTECARLO SIMULATION
...
n = 100
# replace allows us to use repeated values
dice1 = sample(1:6, n, replace = TRUE)            
dice2 = sample(1:6, n, replace = TRUE)
dice3 = sample(1:6, n, replace = TRUE)
#we are generating random values on throw of three 6-faced die
...
# Generate Integers - Binomial Distribution (nCr)
...
hist(x); print(x[1:10])           #prints only 10 entries                     
...
#          Triange made of 3 sides, AB, BC, CA 
#          Each side is 100 units in length
